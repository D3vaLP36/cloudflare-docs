...
> **Note:** SCIM Virtual Groups are deprecated as of 06/02/25. We recommend migrating SCIM Virtual Groups implementations(identified by the pattern CF-<accountID>-<Role Name> in your IdP) to use SCIM User Groups.

Note: "Virtual Groups" (or "Phase 1 user groups"), identified by the pattern CF-<accountID> - <Role Name>, are part of the deprecated method.


Identified by the pattern CF-<accountID>-<Role Name>, are part of the deprecated method
